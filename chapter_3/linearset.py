...
class Set:
    ...
    def intersect(self, setB):
        ...
        for elementB in setB:
            for elementA in self:
                if elementA == elementB and elementA not in newSet:
                    newSet._theElements.append(elementA)
        return newSet
    ...
    # Returns an iterator for traversing the lsit of items.
    def __iter__(self):
